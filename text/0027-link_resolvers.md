...
* Resolvers can be _composed_
* Custom logic can be introduced with a custom resolver

Link resolution breaks all sorts of assumptions about execution time. To deal with this a context is a required argument to link resolution. The only thing you know when you attempt to resolve a link is you don't know how long it will take for that link to properly resovle. To amelorate this, resolving links _must_ respect context cancellation.

### QFS as a base resolver
[qfs](https://github.com/qri-io/qri) is a basic example of a resolver


QriResolver (currently "source")
resolver

### Path Muxing

we can _multiplex_ on paths
...
type Resolver interface {
  Resolve(ctx context.Context, link string) (interface{}, error)
}
```
